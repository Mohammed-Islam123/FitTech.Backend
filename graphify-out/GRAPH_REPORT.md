# Graph Report - FitTech.Backend  (2026-06-02)

## Corpus Check
- 637 files · ~103,768 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4080 nodes · 4218 edges · 656 communities (417 shown, 239 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 51 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0494ed88`
...
9. `Progress Status` - 18 edges
10. `IUserService` - 17 edges

## Surprising Connections (you probably didn't know these)
- `FitTech Platform` --semantically_similar_to--> `FitTech Smart Gym`  [INFERRED] [semantically similar]
  GEMINI.md → README.md
- `FitTech Platform` --semantically_similar_to--> `Project Brief`  [INFERRED] [semantically similar]
  GEMINI.md → .ai/project_brief.md
- `Activity Service (Sessions, Entry-Exit, Attendance)` --shares_data_with--> `Membership Service`  [INFERRED]
  endpoints.txt → tests/membership/members.spec.ts
- `Membership Service` --conceptually_related_to--> `NFC Card System`  [INFERRED]
  AGENTS.md → .ai/project_brief.md
- `Members Service (Member CRUD, Subscriptions List)` --describes_api_for--> `/api/members Endpoint (Member CRUD via MEMBERSHIP direct URL)`  [INFERRED]
  endpoints.txt → tests/membership/members.spec.ts

## Hyperedges (group relationships)
- **FitTech Microservices Architecture** — IdentityService, MembershipService, PaymentService, NotificationService, CoursesService, ActivityService, AggregationService, CommunicationService, TelemetryService, ECommerceService, EquipmentService, ReportingService [EXTRACTED 1.00]
- **Membership Domain Entities** — MemberEntity, PlanEntity, SubscriptionEntity [EXTRACTED 1.00]
- **Membership Service Test Failures** — TestAuthFailure, TestGatewayFailure, TestPlanValidationFailure [EXTRACTED 1.00]
- **FitTech Backend Service Architecture Layer** — endpointstxt_aggregation_service, endpointstxt_members_service, endpointstxt_activity_service, endpointstxt_member_facing, endpointstxt_booking_service, endpointstxt_payments_service, endpointstxt_offline_payment [EXTRACTED 1.00]
...
## Communities (656 total, 239 thin omitted)
...
Cohesion: 0.03
Nodes (22): AcceptCoursePurchaseHandler, AcceptMembershipRenewalHandler, AcceptPurchaseHandler, AcceptRenewalHandler, ActivateMemberHandler, CreatePaymentHandler, CreateProgramHandler, ErrorOr (+14 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (41): A/B Testing Sessions, Asynchronous Programming, Authentication State Reuse, Browser Attachment, Browser Permissions, Browser Session Management, CDP Attachment, Clipboard Operations (+33 more)
...
Cohesion: 0.05
Nodes (14): AttendanceRecordConfiguration, CoachConfiguration, CoursePurchaseRequestConfiguration, MemberActivityConfiguration, PaymentApprovalRequestConfiguration, PaymentConfiguration, PaymentRequestConfiguration, ProgramConfiguration (+6 more)
...
Cohesion: 0.07
Nodes (28): Account Management, Admin Features, Class Management, Class & Schedule Management, Class & Session Management, Coach Dashboard, Coach Features, Features (+20 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (27): Agent Categories, Agent Features, AGENTS.md — FitTech.Backend, Architecture, Business Operations, code:powershell (# Run entire system via Aspire (Docker required)), code:powershell (dotnet ef migrations add <Name> --project Services/Membershi), code:block3 (/agent                    # Browse all agents) (+19 more)
...
Cohesion: 0.14
Nodes (25): Activity Service (Sessions, Entry-Exit, Attendance), Aggregation Service (Dashboard, Finance, Excel Reports), Booking and Scheduling Service (Coaches, Programs, Sessions), FitTech Backend API Endpoints Reference, Member-Facing Endpoints (Profile, Courses, Subscriptions), Members Service (Member CRUD, Subscriptions List), Offline Payment Requests (Renewal, Course Purchase), Payments Service (Payment History) (+17 more)
...
Cohesion: 0.10
Nodes (3): ControllerBase, ServiceAuthController, UserController

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (23): author, bugs, url, dependencies, @playwright/test, description, directories, doc (+15 more)

### Community 29 - "Community 29"
Cohesion: 0.18
Nodes (13): body, userId, body, formData, payload, ADMIN, AuthFixtures, COACH (+5 more)
...
Cohesion: 0.16
Nodes (13): Aspire, Aspire AppHost, Aspire CLI Commands, Aspire Distributed Tracing, Aspire Integrations, Aspire MCP Tools, Aspire Resource Management, Aspire CLI Skill (+5 more)
...
Cohesion: 0.04
Nodes (29): FluentValidation, AbstractValidator, ValidationBehavior, ConfirmCashPaymentValidator, CreateCoachHandler, CreateCoachValidator, CreateMemberValidator, CreatePaymentValidator (+21 more)
...
Cohesion: 0.12
Nodes (16): identity-cluster, identity-api, Address, Destinations, ClusterId, Match, Logging, LogLevel (+8 more)
...
Cohesion: 0.17
Nodes (13): Cross-Service Events, Delete/Deactivate Member, DELETE /api/plans/{id}, GET /api/plans/{id}, GET /api/plans, PUT /api/plans/{id}, Feature: Manage Subscription Plans, Manage Subscription Plans (+5 more)
...
Cohesion: 0.33
Nodes (3): Migration, Identity.Infrastructure.Migrations, InitialCreate
...
Cohesion: 0.15
Nodes (12): 🏗️ Architecture & Technology Stack, Code Structure, code:bash (dotnet run --project FitTech.AppHost/FitTech.AppHost/FitTech), 🛠️ Development Conventions, 📁 Directory Structure, FitTech - Smart Gym Management Platform, 🚀 Getting Started, Patterns & Libraries (+4 more)

### Community 69 - "Community 69"
Cohesion: 0.17
Nodes (13): A/B Testing Sessions, CDP Browser Attachment, playwright-cli attach, playwright-cli -s (session flag), Concurrent Scraping, Playwright Fixtures, Persistent Browser Profile, Playwright Tests Reference (+5 more)
...
Cohesion: 0.20
Nodes (8): CoursePurchaseRequest, CoursePurchaseRequestStatus, PaymentApprovalRequest, PaymentApprovalRequestStatus, PaymentApprovalRequestType, PaymentErrors, string, string
...
Cohesion: 0.29
Nodes (11): CORS Metadata, Gateway Configuration, Identity Cluster, Identity OpenAPI Route, Identity API Route, Membership Cluster, Membership OpenAPI Route, Membership Plans Route (+3 more)
...
Cohesion: 0.20
Nodes (10): Clipboard Operations, Error Handling in run-code, File Downloads, Frames and Iframes, Geolocation and Permissions, JavaScript Execution, Media Emulation, Page Information (+2 more)
...
Cohesion: 0.25
Nodes (8): applicationUrl, commandName, dotnetRunMessages, environmentVariables, launchBrowser, Activity, ASPNETCORE_ENVIRONMENT, profiles
...
Cohesion: 0.27
Nodes (12): EF Core Projections, ErrorOr Result Pattern, Feature: Get Active Subscription, Feature: Get Member Detail, Get Active Subscription, Get Member Detail, Health Profile, Member (+4 more)

### Community 93 - "Community 93"
Cohesion: 0.22
Nodes (8): Logging, LogLevel, Aspire.Hosting, Aspire.Hosting.Dcp, Default, Parameters, rabbitmq-password, rabbitmq-username

### Community 94 - "Community 94"
Cohesion: 0.18
Nodes (10): AllowedHosts, JwtSettings, Issuer, Logging, LogLevel, Default, Microsoft.AspNetCore, ServiceAuth (+2 more)

### Community 95 - "Community 95"
Cohesion: 0.07
Nodes (15): Activity.Migrations, ActivityDbContextModelSnapshot, Aggregation.Migrations, AggregationDbContextModelSnapshot, Chat.Migrations, ChatDbContextModelSnapshot, Courses.Migrations, CoursesDbContextModelSnapshot (+7 more)
...
Cohesion: 0.22
Nodes (7): DelegatingHandler, ServiceTokenHandler, DateTime, HttpClient, ILogger, SemaphoreSlim, string
...
Cohesion: 0.14
Nodes (13): commandName, dotnetRunMessages, profiles, Notification.Api, $schema, $schema, profiles, $schema (+5 more)
...
Cohesion: 0.29
Nodes (8): Create Member, PUT /api/members/{id}, Feature: Update Member, FluentValidation, Identity Service Integration, IIdentityServiceClient, Update Member, Validation Behavior

### Community 107 - "Community 107"
Cohesion: 0.29
Nodes (7): C# 14, C# Naming Conventions, File-Scoped Namespaces, Nullable Reference Types, Pattern Matching, Primary Constructors, Record Types

### Community 108 - "Community 108"
Cohesion: 0.33
Nodes (7): playwright-cli tracing-start / tracing-stop, playwright-cli video commands, Trace File Format, Tracing Reference, Video Overlay API, Video Recording Reference, Trace vs Video Comparison
...
Cohesion: 0.16
Nodes (19): ASPNETCORE_ENVIRONMENT, DOTNET_ENVIRONMENT, environmentVariables, environmentVariables, ASPIRE_ALLOW_UNSECURED_TRANSPORT, ASPIRE_DASHBOARD_MCP_ENDPOINT_URL, ASPIRE_DASHBOARD_OTLP_ENDPOINT_URL, ASPIRE_RESOURCE_SERVICE_ENDPOINT_URL (+11 more)
...
Cohesion: 0.40
Nodes (4): Completion Criteria, Feature: Delete Member (Soft Delete), Feature Roadmap (Ordered), Overall Plan

### Community 123 - "Community 123"
Cohesion: 0.40
Nodes (4): Completion Criteria, Feature: Get Active Subscription, Feature Roadmap (Ordered), Overall Plan

### Community 124 - "Community 124"
Cohesion: 0.40
Nodes (5): Admin Features, Coach Features, FitTech Smart Gym, Member Features, Multi-Role System
...
Cohesion: 0.40
Nodes (4): Completion Criteria, Feature: Get Member Detail, Feature Roadmap (Ordered), Overall Plan

### Community 135 - "Community 135"
Cohesion: 0.40
Nodes (4): Completion Criteria, Feature: Get Subscription History, Feature Roadmap (Ordered), Overall Plan

### Community 136 - "Community 136"
Cohesion: 0.40
Nodes (4): Completion Criteria, Feature: List Members, Feature Roadmap (Ordered), Overall Plan

### Community 137 - "Community 137"
Cohesion: 0.40
Nodes (4): Completion Criteria, Feature: Manage Subscription Plans, Feature Roadmap (Ordered), Overall Plan

### Community 138 - "Community 138"
Cohesion: 0.40
Nodes (4): Completion Criteria, Feature Roadmap (Ordered), Feature: Update Member, Overall Plan
...
Cohesion: 0.04
Nodes (14): AcceptMembershipRenewalEndpoint, ActivateMemberEndpoint, ASP.NET Core, Carter, ConfirmPaymentEndpoint, GetCoachProfileEndpoint, GetEnrolledProgramsEndpoint, GetMyPaymentsEndpoint (+6 more)
...
Cohesion: 0.25
Nodes (8): Admin Role, POST /api/plans, GET /api/members, GET /api/members/{id}, Feature: List Members, List Members, Pagination Pattern, YARP
...
Cohesion: 0.22
Nodes (5): ActiveSubscriptionInfo, IMembershipServiceClient, MemberByCardResponse, MemberValidationResponse, TrackEntryResponse

### Community 172 - "Community 172"
Cohesion: 0.04
Nodes (13): AcceptPurchaseEndpoint, CreateCoachEndpoint, DeleteMemberEndpoint, GetAdminDashboardEndpoint, GetAvailableProgramsEndpoint, GetCoachClientProfileEndpoint, GetSessionHistoryEndpoint, ICarterModule (+5 more)
...
Cohesion: 0.53
Nodes (6): https, applicationUrl, commandName, dotnetRunMessages, launchBrowser, https
...
Cohesion: 0.29
Nodes (5): ServiceTokenHandler, DateTime, HttpClient, IHttpContextAccessor, SemaphoreSlim
...
Cohesion: 0.29
Nodes (6): ServiceTokenHandler, DateTime, HttpClient, ILogger, SemaphoreSlim, string
...
Cohesion: 0.20
Nodes (3): WorkoutLogController, failedTests, status
...
Cohesion: 0.70
Nodes (5): Playwright CLI, Playwright CLI Commands, Playwright CLI Skill, Playwright Element Attributes Reference, Playwright Tests Reference
...
Cohesion: 0.50
Nodes (3): Getting Started, Maven Parent overrides, Reference Documentation

### Community 541 - "Community 541"
Cohesion: 0.50
Nodes (3): Answer, Q: Add fixed member seed Member@fitteck.com with password Member@12345 in DataSeeder.cs, Source Nodes
...
## Knowledge Gaps
- **1170 isolated node(s):** `command`, `args`, `path`, `version`, `main` (+1165 more)
...
- **Why does `ServiceTokenHandler` connect `Community 179` to `Community 99`, `Community 76`, `Community 37`, `Community 183`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `ILogger` connect `Community 37` to `Community 179`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
