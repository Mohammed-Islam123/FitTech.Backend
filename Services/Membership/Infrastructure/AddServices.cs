...
using Membership.Features.Subscriptions.AcceptPurchase;
...
using Membership.Features.Subscriptions.ListPurchaseRequests;
using Membership.Features.Subscriptions.ListRenewalRequests;
using Membership.Features.Subscriptions.OnlinePurchase;
using Membership.Features.Subscriptions.OnlineRenewal;
using Membership.Features.Subscriptions.RejectPurchase;
using Membership.Features.Subscriptions.RejectRenewal;
using Membership.Features.Subscriptions.RequestPurchase;
...
public static class AddServices
{
    public static IServiceCollection AddMembershipServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<OnlinePurchaseHandler>();
        services.AddScoped<RejectPurchaseHandler>();
        services.AddScoped<RequestPurchaseHandler>();
