...
using Courses.Features.Coaches.GetMyProfile;
using Courses.Features.Coaches.GetMyPrograms;
using Courses.Features.Coaches.GetMyPurchaseRequests;
using Courses.Features.Coaches.GetMySessions;
using Courses.Features.Coaches.ListCoaches;
using Courses.Features.Coaches.UpdateMyProfile;
...
public static class AddServices
{
    public static IServiceCollection AddCoursesServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<GetMyProgramsHandler>();
        services.AddScoped<GetMyPurchaseRequestsHandler>();
