...
{
    /// <inheritdoc />
    public partial class SplitCoachName : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExerciseType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Programs_Coaches_CoachId",
                        column: x => x.CoachId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramTimeSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProgramTimeSlots_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessions_ProgramTimeSlots_TimeSlotId",
                        column: x => x.TimeSlotId,
                        principalTable: "ProgramTimeSlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_SessionId_MemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Programs_CoachId",
                table: "Programs",
                column: "CoachId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgramTimeSlots_ProgramId",
                table: "ProgramTimeSlots",
                column: "ProgramId");
