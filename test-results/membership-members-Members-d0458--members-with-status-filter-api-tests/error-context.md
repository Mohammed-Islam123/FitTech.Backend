...
- Name: membership\members.spec.ts >> Membership Members >> list members with status filter
- Location: tests\membership\members.spec.ts:84:7
...
```ts
  1   | import { test, expect, GATEWAY, MEMBERSHIP, ADMIN, MEMBER } from '../fixtures';
  2   | 
